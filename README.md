...
1. **Если есть git**
   ...
   - Вставьте строку
     ```
     git clone https://github.com/ValekusVachpekus/AHK-MVD
     ```
   - Готово!
...
1. **Редактирование файла**
   ...
   - При изменении длины фамилии, должности и звания функция !деп может не туда ставить курсор. Выставьте нужные настройки вручную
...
- Для тонкой настройки используйте документацию AutoHotkey и CRMP-UDF
